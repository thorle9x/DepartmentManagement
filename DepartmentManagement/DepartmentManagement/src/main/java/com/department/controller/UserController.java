...
public class UserController extends AbstractController {
	...
	public ResponseEntity<ServerResponse> getUsers() {
		return new ResponseEntity<>(new ServerResponse(HttpStatusEnum.SUCCESS).setResult(userService.findAll()), HttpStatus.OK);
	}
	...
	public ResponseEntity<ServerResponse> search(@RequestBody UserSearchCriteria userSearchCriteria) {
		return new ResponseEntity<>(
				new ServerResponse(HttpStatusEnum.SUCCESS).setResult(userService.search(userSearchCriteria, userSearchCriteria.pageRequest())), HttpStatus.OK);
	}
